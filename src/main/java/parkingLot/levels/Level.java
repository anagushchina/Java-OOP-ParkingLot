...
public class Level {
    ...
    public void printListOfAvailableSpots(int level, String vehicleType) {
        System.out.printf("Printing a list of available spots for a %s on the level %d%n", vehicleType, level);
        if (vehicleType.equals("motorcycle")) {
            ...
            System.out.println("Wrong vehicle type: " + vehicleType);
            System.out.println();
        }
    }
